import { TranslationResult, Language, WordExplanation, Example } from '../types';

export type ParseFormat = 'json' | 'markdown' | 'plain';
...
// Singleton instance
let parser: ResultParser | undefined;
...
export function resetResultParser(): void {
  parser = undefined;
}
