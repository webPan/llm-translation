...
import '../components/translation/sidebar-page';
import type { SidebarPage } from '../components/translation';
...
async function init() {
  ...
  console.log('[Sidebar] App element found, setting up...');
  ...
  document.addEventListener('action', (e: Event) => {
    ...
    console.log('[Sidebar] Action received:', action, rest);
